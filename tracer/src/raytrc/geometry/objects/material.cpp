...
Material MATERIAL_BASIC(Vec3f(0.4f), Vec3f(0.1f), Vec3f(0.2f), Vec3f(0.0f), Vec3f(0.0f), 3);
Material MATERIAL_METAL_RED(Vec3f(0.7f, 0.0f, 0.0f), Vec3f(0.75f, 0.0f, 0.0f),
                            Vec3f(0.75f, 0.0f, 0.0f), Vec3f(0.0f), Vec3f(0.0f),
                            10);
Material MATERIAL_SHINY_GREEN(Vec3f(0.0f, 0.1f, 0.0f), Vec3f(0.0f, 0.6f, 0.0f),
                              Vec3f(0.0f, 0.7f, 0.0f), Vec3f(0.0f), Vec3f(0.0f),
                             5);
