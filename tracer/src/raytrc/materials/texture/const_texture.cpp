...
const ConstTexture ConstTextures::MIRROR_SIMPLE(Vec3f(0.01f), Vec3f(0.0f),
                                                Vec3f(1.0f), Vec3f(0.99f),
                                                Vec3f(0.0f), 3);
...
const ConstTexture ConstTextures::CYAN_PLASTIC(
